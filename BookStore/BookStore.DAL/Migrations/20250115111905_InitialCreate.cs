        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryyId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookId = table.Column<int>(type: "int", nullable: false),
                    InformationTypeId = table.Column<int>(type: "int", nullable: false),
                    Publish = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookInformations", x => new { x.BookId, x.InformationTypeId });
                    table.ForeignKey(
                        name: "FK_BookInformations_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookInformations_InformationTypes_InformationTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookInformations_InformationTypeId",
